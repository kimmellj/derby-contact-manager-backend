        ...
        if (isset($event['create'])) {
            switch ($event['create']) {
                ...
                case 'organizations':
                    ...
                    $organization->save(
                        array('Organization' =>
                              array('name' => 'Not Affiliated')
                        )
                    );
                    $organization->create();
                    $organization->save(
                        array('Organization' =>
                              array('name' => 'Iron Mountain Roller Girls')
                        )
                    );
                    $organization->create();
                    $organization->save(
                        array('Organization' =>
                              array('name' => 'Free State Roller Derby')
                        )
                    );
                    $organization->create();
                    $organization->save(
                        array('Organization' =>
                              array('name' => 'Key City Roller Derby')
                        )
                    );
                    break;
            }
